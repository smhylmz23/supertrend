...
<style>
  ...
  *{box-sizing:border-box}
  ...
  .kart{background:var(--yuzey);border:1px solid var(--cizgi);border-radius:var(--r-kart);
    padding:16px 17px 14px;position:relative;overflow:hidden;
    transition:border-color var(--gecis),background var(--gecis),transform var(--gecis)}
  .kart::before{content:'';position:absolute;left:0;top:0;bottom:0;width:2px;background:var(--cizgi-2)}
  .kart.guclu::before{background:var(--yesil)}
  .kart.al::before{background:var(--yazi-2)}
  ...
  .e-al{background:var(--yuzey-2);color:var(--yazi-2);border:1px solid var(--cizgi-2)}
  .e-izle{background:transparent;color:var(--soluk);border:1px solid var(--cizgi)}
  ...
  .olcek i{display:block;height:100%;background:var(--cizgi-2);border-radius:99px}
  .kart.guclu .olcek i{background:var(--yesil)}
  .kart.al .olcek i{background:var(--yazi-2)}
